...
require "chef/win32/api/installer" if Chef::Platform.windows? && Chef::Platform.supports_msi?
...
class Chef
  class Provider
    class Package
      class Windows
        class MSI
          include Chef::ReservedNames::Win32::API::Installer if Chef::Platform.windows? && Chef::Platform.supports_msi?
