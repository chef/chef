...
class Chef::EncryptedDataBagItem
  ...
  module Decryptor
    ...
    def self.assert_format_version_acceptable!(format_version)
      unless format_version.is_a?(Integer) and format_version >= Chef::Config[:data_bag_decrypt_minimum_version]
        fail UnacceptableEncryptedDataBagItemFormat,
    ...
    class Version2Decryptor < Version1Decryptor
      ...
      def validate_hmac!
        ...
        if candidate_hmac_matches?(raw_hmac)
          ...
          fail DecryptionFailure, 'Error decrypting data bag value: invalid hmac. Most likely the provided key is incorrect'
        end
      end
