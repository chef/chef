  ...
  class Application
    ...
    class << self
      def debug_stacktrace(e)
        ...
        Chef::FileCache.store("#{Chef::Dist::EXEC}-stacktrace.out", chef_stacktrace_out)
        logger.fatal("Stacktrace dumped to #{Chef::FileCache.load("#{Chef::Dist::EXEC}-stacktrace.out", false)}")
