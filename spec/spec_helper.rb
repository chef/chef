...
RSpec.configure do |config|
  ...
  config.filter_run_excluding openssl_version_check: true unless ENV.fetch("BUILDKITE_BUILD_URL", "") =~ /adhoc/ && ENV.fetch("BUILDKITE_LABEL", "") !~ /(Integration |Functional |Unit )/
