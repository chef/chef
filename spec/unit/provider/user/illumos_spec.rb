...
describe Chef::Provider::User::Illumos do
  ...
  describe "when creating a user" do
    ...
    it "runs useradd with the computed command options" do
      ...
      @provider.should_receive(:unlock_user).and_return(nil)
  ...
  describe "when locking the password" do
    it "should run passwd -l with the new resources username" do
      @provider.should_receive(:shell_out!).with("passwd -N #{@new_resource.username}")
      @provider.lock_pass
    end
  end
  ...
  describe "when unlocking the password" do
    it "should run passwd -u with the new resources username" do
      @provider.should_receive(:shell_out!).with("passwd -d #{@new_resource.username}")
