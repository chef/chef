...
describe Chef::Provider::Package::Rubygems::CurrentGemEnvironment do
  ...
  context "new default rubygems behavior", ruby: ">= 3.0" do
    ...
    it "finds a matching gem candidate version on rubygems 2.0.0+" do
      ...
      stub_request(:get, "https://index.rubygems.org/quick/Marshal.4.8/sexp_processor-4.16.1.gemspec.rz")
        .to_return(status: 200, body: File.binread(File.join(CHEF_SPEC_DATA, "rubygems.org", "sexp_processor-4.16.1.gemspec.rz")))
  ...
  context "old rubygems caching behavior" do
    ...
    it "finds a matching gem candidate version on rubygems 2.0.0+" do
      stub_request(:get, "https://rubygems.org/quick/Marshal.4.8/sexp_processor-4.16.1.gemspec.rz")
        .to_return(status: 200, body: File.binread(File.join(CHEF_SPEC_DATA, "rubygems.org", "sexp_processor-4.16.1.gemspec.rz")))
