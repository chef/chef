...
describe Chef::User do
  ...
  describe 'when serializing to JSON' do
    ...
    it 'includes the name value' do
      @json.should include('"name":"black"')
    end
    ...
    it "includes the 'admin' flag" do
      @json.should include('"admin":false')
    end

    it 'includes the private key when present' do
      @user.private_key('monkeypants')
      @user.to_json.should include('"private_key":"monkeypants"')
    end
    ...
    it 'includes the password if present' do
      ...
      @user.to_json.should include('"password":"password"')
    end
