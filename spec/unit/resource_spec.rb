...
describe Chef::Resource do
  ...
  describe 'notifies' do
    it 'should make notified resources appear in the actions hash' do
      ...
      @resource.delayed_notifications.find { |e| e.resource.name == 'coffee' && e.action == :reload }.should_not be_nil
    end
    ...
    it 'should make notified resources be capable of acting immediately' do
      ...
      @resource.immediate_notifications.find { |e| e.resource.name == 'coffee' && e.action == :reload }.should_not be_nil
    end
    ...
    it 'should allow multiple notified resources appear in the actions hash' do
      ...
      @resource.delayed_notifications.find { |e| e.resource.name == 'beans' && e.action == :reload }.should_not be_nil
    end
  ...
  describe 'subscribes' do
    it 'should make resources appear in the actions hash of subscribed nodes' do
      ...
      zr.delayed_notifications.find { |e| e.resource.name == 'funk' && e.action == :reload }.should_not be_nil
    end
    ...
    it 'should make resources appear in the actions hash of subscribed nodes' do
      ...
      zr = @run_context.resource_collection.find(:zen_master => 'coffee')
      @resource.subscribes :reload, zr
      zr.delayed_notifications.find { |e| e.resource.name == @resource.name && e.action == :reload }.should_not be_nil
    ...
    it 'should make subscribed resources be capable of acting immediately' do
      ...
      zr.immediate_notifications.find { |e| e.resource.name == @resource.name && e.action == :reload }.should_not be_nil
    end
  end
  ...
  describe 'building the platform map' do
    ...
    it 'adds mappings for multiple platforms' do
      ...
      klz.provides :energy, :on_platforms => %w(autobots decepticons)
    end
