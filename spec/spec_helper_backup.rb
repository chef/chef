...
RSpec.configure do |config|
  ...
  config.before(:suite) do
    ARGV.clear
    ARGV << "--chef-license-key=free-c0832d2d-1111-1ec1-b1e5-011d182dc341-112"
  ...
  config.before(:each) do
    ...
    ENV["CHEF_LICENSE_KEY"] = "free-c0832d2d-1111-1ec1-b1e5-011d182dc341-112"
    ...
    ChefLicensing.configure do |conf|
      ...
      conf.chef_product_name = "chef-client"
      conf.chef_entitlement_id = "a5213d76-181f-4924-adba-4b7ed2b098b5"
    end
    # WebMock.stub_request(:get, ).to_return(body: {}, status: 200)
  ...
  valid_free_license_key_2 = "free-c0832d2d-1111-1ec1-b1e5-011d182dc341-112"
  valid_free_license_key = ["free-c0832d2d-1111-1ec1-b1e5-011d182dc341-112"]
    WebMock.stub_request(:get, "#{ChefLicensing::Config.license_server_url}/v1/client")
    .with(query: { licenseId: valid_free_license_key.join(","), entitlementId: ChefLicensing::Config.chef_entitlement_id })
    .to_return(body: { data: client_data, status_code: 200 }.to_json,
                headers: { content_type: "application/json" })

  WebMock.stub_request(:get, "#{ChefLicensing::Config.license_server_url}/v1/listLicenses")
    .to_return(body: { data: [], status_code: 404 }.to_json,
              headers: { content_type: "application/json" })

  WebMock.stub_request(:get, "#{ChefLicensing::Config.license_server_url}/v1/validate")
...
# RSpec.configure do |config|
#   config.before(:each) do
#     WebMock.stub_request(:get, license-server).to_return(body: {}, status: 200)
#   end
# end
