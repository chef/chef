...
function Invoke-After {
    ...
    write-output "uploading chef-universal-mingw-ucrt gem to buildkite UI"
    #C:\buildkite-agent\bin\buildkite-agent.exe artifact upload "${CACHE_PATH}\pkg\chef-${pkg_version}-universal-mingw-ucrt.gem"
