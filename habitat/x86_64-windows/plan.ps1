...
function Invoke-DevkitSmokeTests {
    ...
    # We did that specifically for the Ruby-Devkit package. At the same time, we need to have confidence that we are not being too aggressive in tuning the Devkit.
