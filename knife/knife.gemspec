...
Gem::Specification.new do |s|
  ...
  s.add_dependency "chef-config", "~> 18.6" # ">= #{Chef::Knife::VERSION.split(".").first}"
  s.add_dependency "chef-utils", "~> 18.6" # ">= #{Chef::Knife::VERSION.split(".").first}"
  s.add_dependency "chef", "~> 18.6" # ">= #{Chef::Knife::VERSION.split(".").first}"
