...
buildkite-agent artifact download "C:\omnibus-ruby\chef\pkg\*.msi" . --step "${Env:OMNIBUS_BUILDER_KEY}"
$package_file = (Get-ChildItem "C:\omnibus-ruby\chef\pkg" -Filter "*.msi").FullName
