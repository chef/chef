...
describe Chef::Cookbook do
  ...
  it "should have a list of recipes by name" do
    @cookbook.recipe_files = [ "one", "two" ]
    @cookbook.fully_qualified_recipe_names.detect { |r| r == "openldap::one" }.should eql("openldap::one")
    @cookbook.fully_qualified_recipe_names.detect { |r| r == "openldap::two" }.should eql("openldap::two")
  end
