    ...
    @cookbook.manifest = {
      ...
      [
       ...
       # directory adirectory
       {
         ...
         :path => "files/host-examplehost.example.org/adirectory/anotherfile1.rb",
         :checksum => "csum-host-1",
         :specificity => "host-examplehost.example.org"
       },
       {
         :name => "anotherfile2.rb",
         :path => "files/host-examplehost.example.org/adirectory/anotherfile2.rb",
       ...
       {
         :name => "anotherfile1.rb",
         :path => "files/ubuntu/adirectory/anotherfile1.rb",
         :checksum => "csum-plat-1",
         :specificity => "ubuntu"
       },
       {
         :name => "anotherfile2.rb",
         :path => "files/ubuntu/adirectory/anotherfile2.rb",
       ...
       {
         :name => "anotherfile1.rb",
         :path => "files/default/adirectory/anotherfile1.rb",
         :checksum => "csum-default-1",
         :specificity => "default"
       },
       {
         :name => "anotherfile2.rb",
         :path => "files/default/adirectory/anotherfile2.rb",
