...
gemspec.add_dependency "win32-api", "~> 1.10.1"
...
gemspec.add_dependency "win32-certstore", "~> 0.6.14" # 0.5+ required for specifying user vs. system store
gemspec.add_dependency "chef-powershell", "~> 1.0.13" # The guts of the powershell_exec code have been moved to its own gem, chef-powershell. It's part of the chef-powershell-shim repo.
