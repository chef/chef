...
<!-- latest_release 15.17.5 -->
## [v15.17.5](https://github.com/chef/chef/tree/v15.17.5) (2021-04-19)

#### Merged Pull Requests
- Update tests to handle local omnibus packages from Buildkite artifacts api [#11384](https://github.com/chef/chef/pull/11384) ([nkierpiec](https://github.com/nkierpiec))
<!-- latest_release -->

<!-- release_rollup since=15.17.4 -->
### Changes not yet released to stable

#### Merged Pull Requests
- Update tests to handle local omnibus packages from Buildkite artifacts api [#11384](https://github.com/chef/chef/pull/11384) ([nkierpiec](https://github.com/nkierpiec)) <!-- 15.17.5 -->
<!-- release_rollup -->
