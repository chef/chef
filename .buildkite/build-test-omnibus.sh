...
then
  container_platforms=( "${container_platforms[@]}" "windows-2016:windows-2019" "windows-2025:windows-2019" "windows-2022:windows-2019" "windows-10:windows-2019" "windows-11:windows-2019" )
fi
