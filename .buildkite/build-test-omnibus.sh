...
esoteric_platforms=("aix-7.1-powerpc:aix-7.1-powerpc" "aix-7.2-powerpc:aix-7.1-powerpc" "aix-7.3-powerpc:aix-7.1-powerpc" "el-7-ppc64:el-7-ppc64" "el-7-ppc64le:el-7-ppc64le" "el-7-s390x:el-7-s390x" "el-8-s390x:el-7-s390x" "freebsd-13-amd64:freebsd-13-amd64" "mac_os_x-12-x86_64:mac_os_x-12-x86_64" "mac_os_x-12-arm64:mac_os_x-12-arm64" "mac_os_x-14-arm64:mac_os_x-12-arm64" "mac_os_x-13-arm64:mac_os_x-12-arm64" "solaris2-5.11-i386:solaris2-5.11-i386" "solaris2-5.11-sparc:solaris2-5.11-sparc" "sles-12-x86_64:sles-12-x86_64" "sles-12-s390x:sles-12-s390x" "sles-15-s390x:sles-12-s390x")
...
then
  ...
  for platform in ${esoteric_build_platforms[@]}; do
    ...
    echo "  plugins:"
    echo "  - chef/omnibus#d3b7da585745739e901102f9d5a072322da566e9:"
    echo "      build: chef"
