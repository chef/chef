...
targets=("amazon-2:centos-7" "centos-7:centos-7" "rhel-9:rhel-9" "debian-9:debian-9" "debian-10:debian-9" "debian-11:debian-9" "ubuntu-2004:ubuntu-2004" "ubuntu-2204:ubuntu-2204" "rocky-8:rocky-8" "rocky-9:rocky-9" "amazon-2023:amazon-2023")
...
# win_targets=("windows-2016:windows-2019" "windows-2022:windows-2019" "windows-10:windows-2019" "windows-11:windows-2019")
...
for target in ${targets[@]}; do
  if [[ "${target%:*}" == *"windows"* ]]; then
    ...
    echo "      limit: 1"
    echo "  agents:"
    echo "    queue: omnibus-${target%:*}-x86_64"
    echo "  plugins:"
    echo "    - docker#v3.5.0:"
