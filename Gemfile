...
# Pre-compiled unf_ext gem in rubygems.org has broken ruby version constraints which prevent it
...
group(:ruby_shadow) do
  ...
  gem "ruby-shadow", git: "https://github.com/chef/ruby-shadow", branch: "lcg/ruby-3.0", platforms: :ruby unless RUBY_PLATFORM.match?(/x64-mingw-ucrt/i) || RUBY_PLATFORM.match?(/x64-mingw/i)
end
