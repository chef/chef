...
install_if -> { RUBY_PLATFORM !~ /mswin|mingw|ucrt|windows/ } do
  gem "chef-powershell", git: "https://github.com/chef/chef-powershell-shim.git", branch: "jfm/chef18-chef-powershell-update"
end
