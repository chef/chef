...
group(:ruby_shadow) do
  ...
  gem "ruby-shadow", git: "https://github.com/chef/ruby-shadow", branch: "lcg/ruby-3.0", platforms: :ruby unless RUBY_PLATFORM.match?(/mswin|mingw|windows/)
end
