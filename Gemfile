...
group(:omnibus_package) do
  gem "appbundler"
  gem "rb-readline"
  gem "inspec-core-bin", git: "https://github.com/inspec/inspec.git", glob: "inspec-bin/*.gemspec", tag: "v6.8.4" # need to provide the binaries for inspec
  gem "chef-vault"
end

gem "inspec-core", git: "https://github.com/inspec/inspec.git", tag: "v6.8.4"
