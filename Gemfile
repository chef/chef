...
gem "omnibus", :git => "git://github.com/opscode/omnibus-ruby.git", :branch => 'omnibus-windows'

#gem "omnibus-software", :path => omnibus_software_local_path
gem "omnibus-software", :git => "git://github.com/opscode/omnibus-software.git", :branch => 'omnibus-windows'
