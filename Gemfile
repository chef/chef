...
# gem "rest-client", git: "https://github.com/chef/rest-client", branch: "jfm/ucrt_update1" jfm/chef18-http-accept
gem "rest-client", git: "https://github.com/chef/rest-client", branch: "jfm/chef18-http-accept"
